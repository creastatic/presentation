...
// node_modules/.pnpm/reveal.js@4.5.0/node_modules/reveal.js/plugin/notes/notes.js
var require_notes = __commonJS({
  "node_modules/.pnpm/reveal.js@4.5.0/node_modules/reveal.js/plugin/notes/notes.js"(exports, module) {
    !function(t, e) {
      ...
      function N(t2, e2, n2) {
        ...
        if ("function" == typeof e2 && (n2 = e2, e2 = null), T(e2 = y({}, N.defaults, e2 || {})), n2) {
          ...
          const r2 = function(t3) {
            ...
            if (!t3)
              try {
                e2.walkTokens && N.walkTokens(s2, e2.walkTokens), r3 = O.parse(s2, e2);
              } catch (e3) {
                t3 = e3;
              }
          ...
          if (delete e2.highlight, !s2.length)
            return r2();
          let a2 = 0;
          return N.walkTokens(s2, function(t3) {
        ...
        try {
          ...
          return e2.walkTokens && N.walkTokens(n3, e2.walkTokens), O.parse(n3, e2);
        } catch (t3) {
      ...
      N.options = N.setOptions = function(t2) {
        var n2;
        return y(N.defaults, t2), n2 = N.defaults, e = n2, N;
      }, N.getDefaults = t, N.defaults = e, N.use = function(...t2) {
        const e2 = y({}, ...t2), n2 = N.defaults.extensions || { renderers: {}, childTokens: {} };
        let i2;
        t2.forEach((t3) => {
          if (t3.extensions && (i2 = true, t3.extensions.forEach((t4) => {
            ...
            const n3 = N.defaults.renderer || new C();
          ...
          i2 && (e2.extensions = n2), N.setOptions(e2);
        });
      }, N.walkTokens = function(t2, e2) {
        for (const n2 of t2)
          switch (e2.call(N, n2), n2.type) {
            case "table":
              for (const t3 of n2.header)
                N.walkTokens(t3.tokens, e2);
              for (const t3 of n2.rows)
                for (const n3 of t3)
                  N.walkTokens(n3.tokens, e2);
              break;
            case "list":
              N.walkTokens(n2.items, e2);
              break;
            default:
              N.defaults.extensions && N.defaults.extensions.childTokens && N.defaults.extensions.childTokens[n2.type] ? N.defaults.extensions.childTokens[n2.type].forEach(function(t3) {
                N.walkTokens(n2[t3], e2);
              }) : n2.tokens && N.walkTokens(n2.tokens, e2);
          }
      }, N.parseInline = function(t2, e2) {
        if (null == t2)
        ...
        T(e2 = y({}, N.defaults, e2 || {}));
        try {
          const n2 = I.lexInline(t2, e2);
          return e2.walkTokens && N.walkTokens(n2, e2.walkTokens), O.parseInline(n2, e2);
        } catch (t3) {
          if (t3.message += "\nPlease report this to https://github.com/markedjs/marked.", e2.silent)
            return "<p>An error occurred:</p><pre>" + o(t3.message + "", true) + "</pre>";
          throw t3;
        }
      }, N.Parser = O, N.parser = O.parse, N.Renderer = C, N.TextRenderer = M, N.Lexer = I, N.lexer = I.lex, N.Tokenizer = A, N.Slugger = q, N.parse = N;
      return () => {
        let t2, e2, n2 = null;
        function i2() {
          if (n2 && !n2.closed)
