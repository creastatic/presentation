...
// node_modules/.pnpm/reveal.js@4.5.0/node_modules/reveal.js/plugin/markdown/markdown.js
var require_markdown = __commonJS({
  "node_modules/.pnpm/reveal.js@4.5.0/node_modules/reveal.js/plugin/markdown/markdown.js"(exports, module) {
    !function(e, t) {
      ...
      class O {
        ...
        parse(e2, t2 = true) {
          let n2, r2, s2, i2, l2, a2, o2, c2, p2, u2, g2, d2, f2, k2, x2, m2, b2, w2, y2, _2 = "";
          const z2 = e2.length;
          for (n2 = 0; n2 < z2; n2++)
      ...
      function N(e2, t2, n2) {
        ...
        if ("function" == typeof t2 && (n2 = t2, t2 = null), S(t2 = y({}, N.defaults, t2 || {})), n2) {
      ...
      N.options = N.setOptions = function(e2) {
        var n2;
        return y(N.defaults, e2), n2 = N.defaults, t = n2, N;
      }, N.getDefaults = e, N.defaults = t, N.use = function(...e2) {
        const t2 = y({}, ...e2), n2 = N.defaults.extensions || { renderers: {}, childTokens: {} };
        let r2;
        e2.forEach((e3) => {
      ...
      return () => {
        ...
        return { id: "markdown", init: function(t3) {
          ...
          return n3 || (n3 = new N.Renderer(), n3.code = (e3, t4) => {
            let n4 = "";
            return M.test(t4) && (n4 = t4.match(M)[1].trim(), n4 = `data-line-numbers="${n4}"`, t4 = t4.replace(M, "").trim()), `<pre><code ${n4} class="${t4}">${e3 = e3.replace(/([&<>'"])/g, (e4) => P[e4])}</code></pre>`;
